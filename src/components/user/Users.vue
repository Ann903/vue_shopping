<template>
    <div>
                ...
                <el-table :data="userlist" border stripe>
                    ...
                    <el-table-column label="操作" width="180px">
                        <template slot-scope="scope">
                            ...
                            <!-- 删除按钮  -->
                            <el-button type="danger" icon="el-icon-delete" size="mini" round @click="removeUserById(scope.row.id)"></el-button>
                            <!-- 分配角色按钮 -->
        ...
        <!-- 分配角色的对话框 -->
        <el-dialog title="分配角色" :visible.sync="setRoleDialogVisible" width="50%" @close="setRoleDialogeClosed">
            <div>
