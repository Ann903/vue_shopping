    ...
    <div>
      <!-- 面包屑导肮 -->
        ...
        <el-card>
          ...
          <!-- 步骤条区域 -->
          <!--进度条是通过索引activeIndex来知道是到哪个圈了      减去0是把字符串转换为数字型 -->
          ...
          <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-width="100px" label-position="top">
            <el-tabs v-model="activeIndex" :tab-position="'left'" :before-leave="beforeTabLeave" @tab-click="tabClicked">
              <!-- 与选项卡绑定值 activeIndex 对应的标识符，表示选项卡别名 -->
...
export default {
  ...
  methods: {
    ...
    async getCateList() {
      ...
      // this.$message.success('获取商品分类数据失败')
    ...
    async add() {
      this.$refs.addFormRef.validate(async valid => {
        ...
        // 执行添加的业务逻辑
        // addForm需要用来进行双向绑定，lodash  cloneDeep(obj)深拷贝，这样就可以不改变级联选择器中addForm.goods_cat数组
